...
This project is the OER textbook for CIS105 (Survey of Computer Information Systems) at
...
* community college students in their first computing course
...
[docs/CIS105_CLOs.md](docs/CIS105_CLOs.md). It contains the
...
│   ├── CIS105_CLOs.md          # Official Course Learning Outcomes
...
* Microsoft 365 (Word, Excel, PowerPoint) and a free Airtable account (for testing lab steps)
...
1. **Clone the repository:**
   ...
   ```bash
   git clone https://github.com/jor2050111/cis105.git
   cd cis105
   ```
...
1. **Review prerequisites:** identify what students already know from
   None (chapters teach from zero) and plan the bridge into new content.
...
* [docs/CIS105_CLOs.md](docs/CIS105_CLOs.md) - Official Course Learning Outcomes
