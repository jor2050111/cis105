# Exercise Template (CIS105: Survey of Computer Information Systems)
...
exercise meaningful to community college students in their first computing course. Scenarios should involve genuine
...
* 90% of CIS105 students should complete successfully
...
* 70% of CIS105 students should complete successfully
...
Add any of these blocks when a standalone exercise needs more scaffolding. Code samples below come from a Python-based course. Adapt them to Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser.

### Starter Code

```python
# EXAMPLE from a Python-based course. Adapt to Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser.
