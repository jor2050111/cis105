<!--
GENERIC CHAPTER TEMPLATE for CIS105: Survey of Computer Information Systems

Replace these placeholder tokens before authoring:
  CIS105      Course code (example: CIS123)
  Survey of Computer Information Systems   Full course title
  community college students in their first computing course       Who the students are and what they already know
  None (chapters teach from zero)  Required prior courses or skills
  Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser  The course tech stack (languages, environments, libraries)
...
[Opening narrative paragraph. Hook the reader with an industry-relevant scenario tied to the chapter topic. Make it meaningful to community college students in their first computing course.]

[Second paragraph. Explain why this topic matters in Survey of Computer Information Systems. Connect to course learning outcomes and to prior chapters where the connection is genuine.]
...
* **CLO N.** [Verbatim outcome text from docs/CIS105_CLOs.md]

[List only this chapter's aligned CLOs (usually 1-3), taken from the
CLO-to-chapter mapping table in docs/CIS105_CLOs.md. Quote the
...
[Introduction to this topic: 2-3 paragraphs. Bridge briefly from earlier-chapter knowledge, then introduce the new concept.]
...
# Adapt the language, libraries, and task to Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser.
...
* [Resource 2 Title](URL) - [Why this is valuable for community college students in their first computing course]
* [Resource 3 Title](URL) - [What students will learn]

**Note:** Curate 3-6 resources matched to community college students in their first computing course. Include official documentation, tutorials, industry articles, or interactive exercises at the right depth for the course level.
...
* [ ] CLO alignment block after the MLO list (verbatim outcome text
      from docs/CIS105_CLOs.md, no heading icon)
...
COURSE-SPECIFIC REQUIREMENTS (adapt each to Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser):
* Bloom's level band matches the course level (intro: Remember-Apply.
  Advanced: Apply-Create.)
* Bridge from earlier-chapter concepts (reference them, do not reteach)
* Second person voice ("you") throughout
* Tone matched to community college students in their first computing course
* Split prose sentences before they reach 35 words
* All code tested and working on Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser
