# Try It Yourself Template (Predict-Run-Explain Pattern): CIS105
...
* Focus on common pitfalls in Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser, calibrated to community college students in their first computing course
...
## Examples (from a Python-based course, adapt to Microsoft Word, Excel (including macros and VBA basics), PowerPoint, Airtable, and a modern web browser)
