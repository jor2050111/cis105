...
This textbook teaches to the official course learning outcomes (CLOs) for CIS105:
...
| Tool | Purpose |
|------|---------|
| **Word** | Create, format, and polish professional documents |
| **Excel** | Build workbooks, formulas, charts, and pivot tables |
| **PowerPoint** | Design and deliver clear presentations |
